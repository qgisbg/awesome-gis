...
- [Упражнения по дистанционни методи в геологията](https://mgu.bg/wp-content//uploads/2022/06/RS_Exercises_v3_2022.pdf) - Упражнения по дистанционни методи с отворен софтуер (QGIS, SNAP) на доц. д-р Камен Попов от Минно-Геоложки Университет „Св. Иван Рилски”. Упражненията дават добра представа за основните принципи в дистанционните изследвания, които са всеобхватно приложими и далеч не само в геологията.
- [learnosm.org](https://learnosm.org/en/) - Научи всичко необходимо за OpenStreetMap.
...
- [Chronotrains](https://www.chronotrains.com/) - Интерактивна карта, която показва колко далече можеш да стигнеш с влак за 5 часа от всяка жп гара в Европа.
- [Notable people](https://tjukanovt.github.io/notable-people) - Интерактивна карта, показваща име на известна личност от всяко населено място.
...
- [OpenStreetMap 2012](https://2012.osmz.ru/#10/42.8996/22.6715) - Сравнение на OpenStreetMap през 2012 и 2022.
...
- [МиниТокио3д](https://minitokyo3d.com) - Интерактивна карта на разположението на метровлаковете на Токийското метро в реално време.
